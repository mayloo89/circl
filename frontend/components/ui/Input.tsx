...
export default function Input({
  ...
  return (
    <div>
      ...
      <input
        id={id}
        className={`${label && !labelHidden ? "mt-1 " : ""}block w-full rounded-md border bg-gray-800 px-3 py-2 text-base text-white placeholder-gray-500 shadow-sm focus:outline-none focus:ring-1 ${borderClass} ${className}`}
        {...props}
      />
