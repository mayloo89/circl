          ...
          room.type === "dm" ? (
            ...
            <>
              ...
              <button
                ...
                className={`flex min-h-[44px] min-w-[44px] shrink-0 items-center justify-center rounded p-1.5 text-sm transition-colors ${memberSidebarOpen ? "bg-gray-700 text-white" : "text-gray-400 hover:text-white hover:bg-gray-800"}`}
              >
