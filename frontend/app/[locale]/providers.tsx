...
function AppShell({ children }: { children: React.ReactNode }) {
  ...
  const outerClass = authenticated && !isOnboarding
    ? `flex h-dvh flex-col overflow-hidden pt-[calc(3.5rem+var(--safe-top))] pb-[calc(4rem+var(--safe-bottom))] transition-all duration-200 lg:pt-0 lg:pb-0 ${collapsed ? "lg:ml-16" : "lg:ml-64"}`
    : "min-h-dvh"
