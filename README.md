...
- ✅ **Secret rotation runbook** (`docs/runbooks/secret-rotation.md`): procedures for rotating `JWT_SECRET`, `AUTH_SECRET`, VAPID keys, DB password, and S3 credentials; user-impact notes, hard-logout Redis flush, post-rotation checklist, and rotation log.
